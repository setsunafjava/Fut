(function () {
    ...
    angular
        .module('app.core').directive("editorTime", function () {
            return {
                require: "?ngModel",
                scope: true,
                template: "<input ng-model='value' ng-change='onChange()' type='time'>",
                link: function (scope, element, attrs, ngModel) {
                    if (!ngModel) return;
                    // ngModel.$viewValue = moment(scope.value).format('HH:mm');
                    // ngModel.$modelValue =  moment( ngModel.$modelValue ).format('HH:mm');
